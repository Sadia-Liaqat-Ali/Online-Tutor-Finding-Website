...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM Tutors WHERE tutorName = ?";
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                echo "<script>alert('Login Successful'); window.location='tutor_dashboard.php';</script>";
            } else {
...
<head>
    ...
    <title>Tutor Login | EduConnect Pro</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="login-card row g-0">
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <div class="login-left">
                    <div class="brand-logo">
                        <i class="fas fa-chalkboard-teacher"></i>EduConnect Pro
                    </div>
                    <p class="brand-slogan">Empowering educators to transform lives through personalized learning</p>
                    ...
                    <ul class="feature-list">
                        <li>
                            ...
                            <span>Professional tutor dashboard</span>
                        </li>
                        <li>
                    ...
                    <div class="mt-auto text-center w-100">
                        <p>New to our platform? <a href="register.php" class="text-white fw-bold">Join as a tutor</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="login-right">
                    ...
                    <p class="form-subtitle">Sign in to your tutor account</p>
                    
                    <form method="post">
                        <div class="mb-3">
                            <label for="tutorName" class="form-label">Tutor Username</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                <input type="text" class="form-control" id="tutorName" name="tutorName" placeholder="Enter your username" required>
                            </div>
                        </div>
